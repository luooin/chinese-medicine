				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="zuozhenshijian" id="zuozhenshijian" placeholder="坐诊时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">挂号价格</label>
							<div class="layui-input-block">
								<input type="text" name="guahaojiage" id="guahaojiage" placeholder="挂号价格" autocomplete="off" class="layui-input">
							</div>
						</div>
