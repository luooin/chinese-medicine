      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="zuozhenshijian" name="zuozhenshijian" placeholder="请输入坐诊时间" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="guahaojiage" name="guahaojiage" placeholder="请输入挂号价格" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
