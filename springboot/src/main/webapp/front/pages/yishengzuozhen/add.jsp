				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.shanzhanglingyu" type="text" name="shanzhanglingyu" id="shanzhanglingyu" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">坐诊时间：</label>
						<div class="layui-input-block">
							<input v-model="detail.zuozhenshijian" type="text" name="zuozhenshijian" id="zuozhenshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">挂号价格：</label>
						<div class="layui-input-block">
							<input v-model="detail.guahaojiage" type="text" name="guahaojiage" id="guahaojiage" autocomplete="off" class="layui-input">
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                            ...
                                                            if(!isIntNumer(data.guahaojiage)){
                        layer.msg('挂号价格应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('yishengzuozhen' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
