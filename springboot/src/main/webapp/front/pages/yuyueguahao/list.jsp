        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="yuyuemingcheng" id="yuyuemingcheng" placeholder="预约名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../yuyueguahao/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#yuyuebianhao').val()) {
          param['yuyuebianhao'] = jquery('#yuyuebianhao').val() ? '%' + jquery('#yuyuebianhao').val() + '%' : '';
        }  
        if (jquery('#yuyuemingcheng').val()) {
          param['yuyuemingcheng'] = jquery('#yuyuemingcheng').val() ? '%' + jquery('#yuyuemingcheng').val() + '%' : '';
        }  
