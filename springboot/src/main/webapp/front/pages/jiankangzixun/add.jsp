			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-inline" style="line-height: 50px;">
							<input type="hidden" :value="detail.ziliaofujian" id="ziliaofujian" name="ziliaofujian" />
                            <button type="button" class="layui-btn btn-theme" id="ziliaofujianUpload">
								<i class="layui-icon">&#xe67c;</i>上传资料附件
							</button>
							<a download="资料附件" :href="detail.ziliaofujian">点击下载资料附件</a>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				var tupianUpload = upload.render({
                    ...
                    images_upload_handler: function(blobInfo, succFun, failFun) {
                        ...
                        xhr.send(formData);
												                ...
												                var ziliaofujianUpload = upload.render({
					//绑定元素
					elem: '#ziliaofujianUpload',
					//上传接口
					url: http.baseurl + 'file/upload',
					// 请求头
					headers: {
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							var url = http.baseurl + 'upload/' + res.file;
							jquery('#ziliaofujian').val(url);
                            vue.detail.ziliaofujian = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('jiankangzixun' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
