					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="binglimingcheng" id="binglimingcheng" placeholder="病例名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="bingqing" id="bingqing" placeholder="病情" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">检查项目</label>
							<div class="layui-input-block">
								<input type="text" name="jianchaxiangmu" id="jianchaxiangmu" placeholder="检查项目" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">检查结果</label>
							<div class="layui-input-block">
								<input type="text" name="jianchajieguo" id="jianchajieguo" placeholder="检查结果" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">药单</label>
							<div class="layui-input-block">
								<input type="text" name="yaodan" id="yaodan" placeholder="药单" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
